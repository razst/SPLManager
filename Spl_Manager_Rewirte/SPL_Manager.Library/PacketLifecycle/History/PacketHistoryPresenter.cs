...
namespace SPL_Manager.Library.PacketLifecycle.History
{
    ...
    public class PacketHistoryPresenter
    {
        ...
        public PacketHistoryPresenter(IPacketsRepository repository)
        {
        ...
        public PacketHistoryPresenter() : this(PacketsRepository.Instance) { }
