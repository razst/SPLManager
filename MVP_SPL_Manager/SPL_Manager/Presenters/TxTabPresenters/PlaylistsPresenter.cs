...
namespace SPL_Manager.Presenters.TxTabPresenters
{
    ...
    public class PlaylistsPresenter
    {
        ...
        public PlaylistsPresenter(IView view, IPlaylistRepository repository = null)
        {
            _txView = (ITxTabView)view;
            _plView = (IPlaylistsView)view;

            if (repository == null) _repository = new PlaylistRepository();
        ...
        public void UpdateCurrentPlaylist()
        {
            ...
            _plView.PlayListItems = plItem.Items.ConvertAll(item => item.GetSubTypeName());
