...
namespace SPL_Manager.Library.Presenters.QueryTabPresenters
{
    ...
    {
        private IQuerySelectionView _view;
        private PacketSubtype CurrentSubtype;
        private readonly JsonService jsonService;


        public QuerySelctionPresenter()
        {
            jsonService = new JsonService(ProgramProps.PacketJsonFiles["Rx"]);
        }

        public void SetView(IQuerySelectionView view)
        {
            _view = view;
        }
