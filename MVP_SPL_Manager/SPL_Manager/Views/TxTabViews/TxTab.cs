...
namespace SPL_Manager.Views.TxTabViews
{
        ...
        IPlaylistsView
    {
        ...
        public void Init(PacketServerPresenter packetServer)
        {

            PacketServerPresenter = packetServer;

            CreatePacketPresenter = new CreatePacketPresenter(this);
            PlaylistsPresenter = new PlaylistsPresenter(this);
