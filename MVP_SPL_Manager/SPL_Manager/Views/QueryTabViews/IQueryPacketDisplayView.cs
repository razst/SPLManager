...
namespace SPL_Manager.Views.QueryTabViews
{
    public interface IQueryPacketDisplayView
    {
        ...
        public Presenters.QueryTabPresenters.QueryPacketDisplayPresenter QueryPacketDisplayPresenter { get; set; }
        public Presenters.QueryTabPresenters.QuerySelctionPresenter QuerySelctionPresenter { get; set; }
    }
}
